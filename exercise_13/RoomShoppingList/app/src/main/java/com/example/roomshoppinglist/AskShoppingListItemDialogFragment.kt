        ...
        return activity?.let {
            ...
            builder.setTitle(R.string.dialog_title)
                ...
                .setPositiveButton(R.string.dialog_ok) { dialog, _ ->
                    ...
                    val count = customView.countEditText.text.toString().toIntOrNull()
                    val price = customView.priceEditText.text.toString().toDoubleOrNull()
                    if (name.isNullOrBlank() || name.isNullOrEmpty()) {
                        // customView.nameEditText.requestFocus()
                    } else if (count == null) {
                        // customView.countEditText.requestFocus()
                    } else if (price == null) {
                        // customView.priceEditText.requestFocus()
                    } else {
